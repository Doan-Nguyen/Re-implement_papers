...
tf.app.flags.DEFINE_integer('max_number_of_steps', 200000, 'The maximum number of training steps.') ### 100000
...
tf.app.flags.DEFINE_string(
    'dataset_name', 'dataset_ocr', 'The name of the dataset to load.')
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')
tf.app.flags.DEFINE_string(  
    'dataset_dir', "./datasets/dataset_ocr", 'The directory where the dataset files are stored.') ###
